...
else
{
    ...
    $oRequest = "SELECT ".$c."_image, ".$c."_name, ".$c."_id, ".$c."_class FROM ".$c."_ukr WHERE ".$c."_class IN (".$selected.") ORDER BY ".$c."_name ASC";
    ...
    while($oArr = mysqli_fetch_array($obj))
    {
        ...
        echo "<div class='s-obj'>                      
                  <div class='s-img'>
                        <a href='/newUniverse/pages/object_ukr.php?objectId=".$objId."&o=".$c."&t=".$c."'><img src='".$img."' width='100%'></a>
                        <div class='s-inf'>
                            <div class='s-title boxSizingStyle'>".$name."<div class='s-class'>".$class."</div></div>
                            <div class='s-button boxSizingStyle'><a href='/newUniverse/pages/object_ukr.php?objectId=".$objId."&o=".$c."&t=".$c."'>Читати</a></div>
                        </div>
                  </div>
              </div>";
    }
