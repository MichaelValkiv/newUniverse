...
<div class="o-cont transitionBox">
    ...
    <div class="sameTypeObjects bg_color1 boxSizingStyle transitionBox">
        ...
        <div class="sTO boxSizingStyle">
            ...
            include ($_SERVER["DOCUMENT_ROOT"]."/newUniverse/blocks/connection.php");
            include ($_SERVER["DOCUMENT_ROOT"]."/newUniverse/blocks/protector.php");
            $otherObjectsRequest = "SELECT ".$o."_id, ".$o."_name, ".$o."_image FROM ".$t."_ukr WHERE ".$o."_id != ".$oId." LIMIT 15";
            ...
            while($otherObjectsArr = mysqli_fetch_array($otherObjects))
            {
                ...
                echo "<a href='/newUniverse/pages/object_ukr.php?objectId=".$otherObjectsId."&o=".$o."&t=".$t."'>  
    ...
    <div class="objInfo transitionBox boxSizingStyle">
        ...
        include ($_SERVER["DOCUMENT_ROOT"]."/newUniverse/blocks/connection.php");
        include ($_SERVER["DOCUMENT_ROOT"]."/newUniverse/blocks/protector.php");
        $objectRequest = "SELECT ".$o."_name, ".$o."_description, ".$o."_image, ".$o."_caption, ".$o."_properties, ".$o."_objects FROM ".$t."_ukr WHERE ".$o."_id = ".$oId;
        ...
        while($objectsArr = mysqli_fetch_array($objects))
        {
            ...
            echo "<div class='thisObjectTitle bg_color1 boxSizingStyle transitionBox'>".$objectName."</div>
                  ...
                  <div class='objectDesc bg_color1 fontBox boxSizingStyle transitionBox'><div class='tBox'>Про Об'єкт</div>".$objectDescription."</div>";
        }
    ...
    <div class="ch_ab">
        <div class="characteristicsBox bg_color1 boxSizingStyle transitionBox">
            <div class="tBox">Характеристики<div class="bodyStyleButton boxSizingStyle transitionBox targetBox" href=".targetBox">Зручний режим читання</div></div>
        ...
        <div class="abbreviationBox bg_color1 boxSizingStyle transitionBox">
            <div class="tBox">Позначення<div class="bodyStyleButton boxSizingStyle transitionBox targetBox" href=".targetBox">Зручний режим читання</div></div>
