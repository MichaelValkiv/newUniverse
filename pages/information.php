...
<div class="iCont transitionBox">
    ...
    <div class="thisTypeObjects boxSizingStyle">
        <div class="objectForm boxSizingStyle transitionBox">
                ...
                include ($_SERVER["DOCUMENT_ROOT"]."/newUniverse/blocks/connection.php");
                include ($_SERVER["DOCUMENT_ROOT"]."/newUniverse/blocks/protection.php");
                $thisTypeObjRequest = "SELECT information_obj, information_class FROM information WHERE information_class = '".$c."' AND information_number != 1 ORDER BY information_number ASC";
                echo "<form action='/newUniverse/pages/information.php?c=".$c."' method='post' id='objForm'>
                      <input type='checkbox' id='allBoxes' name='object' value='' class='iCheckbox'><label for='allBoxes' class='iCheckboxLabel allSelect'><div class='infoObjectTabs infoObjectTabsAll transitionBox'>All</div></label>";
        ...
        <div class="infoContent boxSizingStyle transitionBox">
            <?php
                include ($_SERVER["DOCUMENT_ROOT"]."/newUniverse/blocks/connection.php");
                include ($_SERVER["DOCUMENT_ROOT"]."/newUniverse/blocks/protection.php");
                $infoRequest = "SELECT information_obj, information_info, information_class, information_image, information_caption FROM information WHERE information_class = '".$c."' ORDER BY information_number ASC";
    ...
    <script>
        $(document).ready(function () {
            $('.iCheckbox').change(function(){
                ...
                $.ajax({
                    type: "POST",
                    url: "/newUniverse/blocks/selector.php?c="+c,
