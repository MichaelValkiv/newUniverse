            ...
            <div class="i-item-items boxSizingStyle transitionBox" id="i-planets-items">
                <div class="i-i-item transitionBox">
                    ...
                    include ($_SERVER["DOCUMENT_ROOT"]."/newUniverse/blocks/connection.php");
                        $planets = mysqli_query($dbQuery, "SELECT planets_id, planets_name, planets_radius, planets_mass, planets_image FROM planets LIMIT 5" );
                        while($planetsArr = mysqli_fetch_array($planets))
                        {
                            ...
                            $tName = 'planets';
                            $oName = 'planets';
                            echo "<a href='/newUniverse/pages/object.php?objectId=".$planetId."&o=".$oName."&t=".$tName."'>
        ...
        <div class="i-item" id="i-stars">
            ...
            <div class="i-item-items boxSizingStyle transitionBox" id="i-stars-items">
                <div class="i-i-item transitionBox">
                    <?php
                    include ($_SERVER["DOCUMENT_ROOT"]."/newUniverse/blocks/connection.php");
                        $stars = mysqli_query($dbQuery, "SELECT stars_id, stars_name, stars_radius, stars_mass, stars_image FROM stars LIMIT 5");
                        while($starsArr = mysqli_fetch_array($stars))
                        {
                            ...
                            $tName = 'stars';
                            $oName = 'stars';
                            echo "<a href='/newUniverse/pages/object.php?objectId=".$starId."&o=".$oName."&t=".$tName."'>
                                    <div class='items bg_color1 boxSizingStyle transitionBox'>
        ...
        <div class="i-item" id="i-satellites">
            ...
            <div class="i-item-items boxSizingStyle transitionBox" id="i-satellites-items">
                <div class="i-i-item transitionBox">
                    <?php
                    include ($_SERVER["DOCUMENT_ROOT"]."/newUniverse/blocks/connection.php");
                        $satellites = mysqli_query($dbQuery, "SELECT satellites_id, satellites_name, satellites_radius, satellites_mass, satellites_image FROM satellites LIMIT 5");
                        while($satellitesArr = mysqli_fetch_array($satellites))
                        {
                            ...
                            $tName = 'satellites';
                            $oName = 'satellites';
                            echo "<a href='/newUniverse/pages/object.php?objectId=".$satelliteId."&o=".$oName."&t=".$tName."'>
                                    <div class='items bg_color1 boxSizingStyle transitionBox'>
        ...
        <div class="i-item" id="i-galaxies">
            ...
            <div class="i-item-items boxSizingStyle transitionBox" id="i-galaxies-items">
                <div class="i-i-item transitionBox">
                    <?php
                    include ($_SERVER["DOCUMENT_ROOT"]."/newUniverse/blocks/connection.php");
                        $galaxies = mysqli_query($dbQuery, "SELECT galaxies_id, galaxies_name, galaxies_type, galaxies_distance, galaxies_image FROM galaxies LIMIT 5");
                        while($galaxiesArr = mysqli_fetch_array($galaxies))
                        {
                            ...
                            $tName = 'galaxies';
                            $oName = 'galaxies';
                            echo "<a href='/newUniverse/pages/object.php?objectId=".$galaxyId."&o=".$oName."&t=".$tName."'>
                                    <div class='items bg_color1 boxSizingStyle transitionBox'>
